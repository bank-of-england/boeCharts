...
`boeCharts` v1.1.0 (released in September) brought with it:
...
.font200[What's next for *boeCharts*]
...
- Better examples of "using grey" (a la [gghighlight](https://yutannihilation.github.io/gghighlight/))
